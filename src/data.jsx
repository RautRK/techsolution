...
export const contactInfo = [
  {
    ...
    value: "alimukhtar1732@gmail.com",
...
export const blogPost = [
  {
    title:
      "Transforming Healthcare with AI: How TechSolution is Empowering Better Patient Outcomes",
    content:
      "This blog post explores TechSolution impact on healthcare through AI-powered solutions, such as predictive analytics and machine learning tools that help medical professionals make data-driven decisions and optimize patient care.",
    image: blog1,
  },
  {
    title:
      "Protecting Businesses from Cyber Threats:TechSolution Approach to Modern Cybersecurity",
    content:
  ...
  {
    title:
      "Building Smart Cities with IoT: TechSolution Vision for Sustainable Urban Development",
    content:
      "This blog post dives into how TechSolution is leveraging IoT to enable smart city infrastructure. Discuss IoT’s role in making cities more efficient, sustainable, and data-centric, with examples of how Datawave’s solutions have been implemented in urban development projects.",
    image: blog3,
  },
];
...
export const clientsReviews = [
  {
    content:
      "TechSolution transformed our outdated systems into a seamless, secure infrastructure. Their team is exceptionally skilled and always available to assist.",
    name: "Sophia Roberts",
  ...
  {
    content:
      "Partnering with TechSolution has been a game-changer for our digital operations. Their innovative approach helped us scale effortlessly.",
    name: "Rajesh Patel",
  ...
  {
    content:
      "TechSolution cloud solutions have boosted our productivity significantly. I can’t recommend their services enough!",
    name: "Emily Nguyen",
  ...
  {
    content:
      "Our cybersecurity has never been stronger. TechSolution identified and identified vulnerabilities we didn’t know existed and resolved them efficiently.",
    name: "James O’Connor",
  ...
  {
    content:
      "The team at TechSolution delivered ahead of schedule and exceeded expectations. Their professionalism and expertise are unmatched.",
    name: "Fatima Yusuf",
  ...
  {
    content:
      "TechSolution provided scalable solutions that have supported our rapid growth. Their ongoing support ensures we’re always ahead.",
    name: "Liam Carter",
